...
class NewUserZoneController extends GetxController {
  ...
  List<NewUserZoneDatum> newUserProducts = <NewUserZoneDatum>[].obs;
  ...
  Future<List<NewUserZoneDatum>> getNewUserZoneProducts({required String slug}) async {
  ...
  Future<List<ProductModel>> getCategoryAllProducts({required String slug}) async {
  ...
  Future<List<ProductModel>> getCouponAllProducts({required String slug}) async {
    AllProducts parentCategoryElement = AllProducts();
    try {
      isCategoryAllProductLoading(true);
      isMoreCategoryAllProductLoading(true);
  ...
  Future<List<ProductModel>> getCategoryProducts({required String slug}) async {
    AllProducts parentCategoryElement = AllProducts();
    try {
  ...
  Future<List<ProductModel>> getCouponProducts({required String slug}) async {
    AllProducts parentCategoryElement = AllProducts();
    try {
      isCategoryProductLoading(true);
      isMoreCategoryProductLoading(true);
