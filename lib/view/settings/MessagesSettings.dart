...
import 'package:amazcart/model/NewModel/NotificationSettingsModel.dart';
                            ...
                            children: [
                              ...
                              Wrap(
                                ...
                                children: List.generate(types.length, (tp) {
                                  ...
                                  bool type = false;
                                  if (notificationTypes?.contains(types[tp]) == true) {
                                    type = true;
                                  }
                                    ...
                                    children: [
                                      ...
                                      Checkbox(
                                        ...
                                        onChanged: (bool? value) async {
                                          ...
                                          Map data = {'id': snapshot.data?.notifications?[index].id,
                                            'type': '${types[tp]}',
                                          };
                                          print(data);
