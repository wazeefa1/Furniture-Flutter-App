...
class ClickPayGateway extends StatefulWidget {
  @override
  _ClickPayGatewayState createState() => _ClickPayGatewayState();
}

class _ClickPayGatewayState extends State<ClickPayGateway> {
