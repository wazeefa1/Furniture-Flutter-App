      ...
      child: Scaffold(
        body: ListView(
          ...
          children: [
            ...
            (controller.catAllData.value.attributes?.length ?? 0) > 0
                ? ListView.builder(
                shrinkWrap: true,
                ...
                itemBuilder: (context, attIndex) {
                  return Column(
                    ...
                    children: [
                      ...
                      (controller.catAllData.value.attributes?[attIndex].values?.length ?? 0) > 0
                          ? Builder(
                        builder: (context) {
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (controller.selectedAttribute
                                        ...
                                        await controller
                                            ...
                                            attIndex]
                                                .id
                                                .toString(), colorValue: FilterColorValue());
            ...
            controller.catAllData.value.color != null
                ? (controller.catAllData.value.color?.values?.length ?? 0) > 0
                ? Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                SizedBox(
              ...
              builder: (context) {
                ...
                return MultiSelectChipField<FilterColorValue?>(
                  ...
                  itemBuilder: (item, state) {
                    ...
                    //   print("ITEMMMMMM:${item.value?.value!}");
                    //   bgColor = controller
                        ...
                        onTap: () async {
                          ...
                          if (controller.selectedColorValue
                            ...
                            await controller.addFilterAttribute(
                                ...
                                typeId: controller
                                    .catAllData.value.color?.id ?? ''
                                    .toString(), value: FilterAttributeValue());
                            await doFilter();
                          }
                        },
                        child: Container(
